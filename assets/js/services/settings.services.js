// =============================================================
// SERVICE: CONFIGURAÇÕES VISUAIS — VM VENDAS E COMPRAS
// =============================================================
...
export async function carregarConfiguracoes(force = false) {
  ...
  try {
    ...
    return { company: {}, store: {}, visual: {} };
  }
}

// Aplica as cores e configurações visuais como CSS Variables + título + favicon
export function aplicarConfiguracoes({ company = {}, store = {}, visual = {} }) {
  ...
  // Título da aba — usa nome da loja se existir
